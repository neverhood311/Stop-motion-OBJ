...
def register():
    ...
    bpy.utils.register_class(BakeMeshSequenceShapeKeys)
    bpy.utils.register_class(BakeMeshSequenceShapeKeysCompressed)
...
def unregister():
    ...
    bpy.utils.unregister_class(BakeMeshSequenceShapeKeys)
    bpy.utils.unregister_class(BakeMeshSequenceShapeKeysCompressed)
